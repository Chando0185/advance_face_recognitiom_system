...
const Records = () => {
    ...
    const handleClearData = () => {
        if (window.confirm('Are you sure you want to clear all attendance and registration records? This action cannot be undone.')) {
            clearAllData();
            setRecords([]);
        }
    };
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold gradient-text">Attendance Records</h1>
                    <p className="text-slate-400">Manage and view all locally stored attendance logs.</p>
                </div>
