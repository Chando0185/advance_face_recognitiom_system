            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                <div className="space-y-4">
                    ...
                    <div className="text-xs text-slate-500 flex items-center gap-2 px-2">
                        ...
                        {isCameraReady ? 'Camera Ready' : 'Camera Disconnected'}
                    </div>
                </div>
                ...
                <form onSubmit={handleRegister} className="glass-card p-6 space-y-6">
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-400 mb-1">ID / Roll Number (Optional)</label>
                            <input
                                type="text"
                                value={userId}
                    ...
                    <AnimatePresence>
                        {status === 'success' && (
                            ...
                            >
                                <CheckCircle size={20} />
                                <span className="text-sm">Registration successful! Data saved locally.</span>
                            </motion.div>
                        )}
                        {status === 'error' && (
                            <motion.div
